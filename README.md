...
| 2026-07-03 | 使用 `v2_upgrade.sql` 升级本地 SQL Server 数据库 | 成功；补齐信用分、违规申诉表和信用规则配置 |
| 2026-07-03 | 启动后端并调用登录、`/api/auth/me`、学生违规列表、管理员用户列表、规则配置和申诉列表接口 | 成功；学生信用分返回 100，管理员可读取 `credit_low_threshold=60` |
