...
export const pageConfigs = {
  studentHome: { section: '学生端', icon: House, title: '学生首页', subtitle: '查看今日预约、公告消息、信用状态和常用入口' },
  spaceReserve: { section: '学生端', icon: Calendar, title: '空间预约', subtitle: '按空间类型、日期和时间选择座位、工位或整间空间' },
  reservation: { section: '学生端', icon: Calendar, title: '空间预约', subtitle: '按空间类型、日期和时间选择座位、工位或整间空间' },
  myReservation: { section: '学生端', icon: Tickets, title: '我的预约', subtitle: '查看预约状态，并进行取消、签到、暂离、返座和结束使用' },
  aiTask: { section: '学生端', icon: Cpu, title: 'AI 智能推荐', subtitle: '根据偏好和可用座位，自动匹配并创建预约任务' },
  studentRepairs: { section: '学生端', icon: Service, title: '资源报修', subtitle: '提交空间或座位故障，查看处理进度' },
  studentNotifications: { section: '学生端', icon: List, title: '我的消息', subtitle: '查看预约、审批、报修、违规和公告等系统消息' },
  studentStatistics: { section: '学生端', icon: DataAnalysis, title: '学习统计', subtitle: '查看学习时长、预约次数和常用空间' },
  violation: { section: '学生端', icon: Warning, title: '信用与违规', subtitle: '查看违规原因、信用扣分、封禁状态，并提交申诉' },
  adminDashboard: { section: '管理端', icon: DataAnalysis, title: '后台首页', subtitle: '查看今日预约、审批、报修和运营概览' },
  userManage: { section: '管理端', icon: User, title: '用户与信用管理', subtitle: '管理学生账号、封禁状态和信用分调整' },
  adminRegister: { section: '管理端', icon: User, title: '注册新管理员', subtitle: '创建管理员账号并设置是否允许继续注册管理员' },
  spaceManage: { section: '管理端', icon: OfficeBuilding, title: '空间资源管理', subtitle: '维护空间类型、开放状态、审批规则和签到范围' },
  roomManage: { section: '管理端', icon: OfficeBuilding, title: '空间资源管理', subtitle: '维护空间类型、开放状态、审批规则和签到范围' },
  seatManage: { section: '管理端', icon: Grid, title: '座位/工位管理', subtitle: '以网格方式管理座位、故障状态和可用状态' },
  timeNodeManage: { section: '管理端', icon: Clock, title: '时间节点管理', subtitle: '维护线上预约可选择的开始和结束时间节点' },
  ...
  adminConfigs: { section: '管理端', icon: Service, title: '规则配置', subtitle: '维护预约、签到、暂离、封禁、信用、AI、审批和报修规则' },
  ...
  violationManage: { section: '管理端', icon: WarningFilled, title: '信用治理', subtitle: '查看违规记录、处理申诉，并维护学生履约信用' },
